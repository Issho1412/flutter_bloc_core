const String sFontDefault = 'Muli';
const String sDescription =
    "Wireless Controller for PS4™ gives you what you want in your gaming from over precision control your games to sharing …";

const String sBtnbackHome = 'Back to Home';
...
const String sspecialforyou = 'Special for you';
const String sseemore = 'See more';
const String sCategorysmartphone = 'Smartphone';
const String sCategoryfashion = 'Fashion';
const String sPopularproducts = 'Popular products';
...
const String sProfileItem4 = 'Log out';
